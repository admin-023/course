...
public class SystemApplication23 {

	private static final Logger LOG= LoggerFactory.getLogger(SystemApplication23.class);

	public static void main(String[] args) {
		SpringApplication app = new SpringApplication(SystemApplication23.class);
