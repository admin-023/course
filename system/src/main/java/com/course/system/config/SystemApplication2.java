...
public class SystemApplication2 {

	private static final Logger LOG= LoggerFactory.getLogger(SystemApplication2.class);

	public static void main(String[] args) {
		SpringApplication app = new SpringApplication(SystemApplication2.class);
